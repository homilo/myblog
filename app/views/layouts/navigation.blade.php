<div class="navbar navbar-default navbar-static-top" role="navigation" style="border-radius: 10px 10px 0px 0px;">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ URL::to('/') }}"><i class="fa fa-cubes"></i> Homilor</a>
        </div>

        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="{{ active('posts') }}"><a href="{{ URL::to('posts') }}">Post</a></li>
